...
export default function TrabalheConosco() {
  ...
  const vagas = [
    ...
    "Auxiliar Geral de Linha de Produção",
    ...
    "Processista",
    "Programador de Máquinas e Ferramentas CNC",
    "Rebarbador de Metais",
    "Supervisor de Almoxarifado",
    "Técnico e Analista de Recebimento de Peças",
    "Técnico Mecânico em Manutenção Industrial",
    "Técnico Eletricista em Manutenção Industrial",
    "Tratorista",
  ];
